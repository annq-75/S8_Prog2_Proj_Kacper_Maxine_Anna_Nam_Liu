...
public class ServerPacketProcessor implements PacketProcessor {
	...
	private void sendOnlineUsers(int requesterId) {//Здесь мы просто проходим по всем пользователям UserMsg, проверяем isConnected(), исключаем самого себя, и собираем строку вида "2,3,5,".
	...
	private void sendTextResponse(int destId, String message) {//Метод, который сервер использует для отправки ответа клиенту
